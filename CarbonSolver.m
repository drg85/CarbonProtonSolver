...
disp('Carbon ion Energy Bethe Equation solver: David Robert Grimes and Daniel Warren, University of Oxford.')
...
mp = 12*1.6726219e-27; %particle mass - in this case proton
z = 6; %charge in multiples of electron
c = 299792458; %speed of light

pe = input('Enter initial Energy / a.m.u in MeV : ');
ke_p = 12*pe*1e6*e; % proton energy (converted from MeV ie. 150 MeV)
